...
export const ChatList = () => {
    ...
    const sendMessage = () => {
        if (isSend.trim().length > 0) {
            const newMessage: Message = { id: Date.now().toString(), text: isSend, type: "sent" };
...
const styles = StyleSheet.create({
    ...
    sent: { alignSelf: "flex-end", backgroundColor: "#00A884" },
    ...
    audioText: { marginLeft: 10, color: "white", fontSize: 16 },
    ...
    input: { fontSize: sizes.size12, color: COLORS.off_white_gray },
